...
coin_flip_bet = input("How much you wanna bet? ")
coin_flip_bet = int(coin_flip_bet)


def heads_or_tails(coin_flip_call, coin_flip_bet):
    ...
    if coin_flip_call == result:
        print("The result of the coin flip is " + result + ". Congratulations! You have won " + str(coin_flip_bet) + "!")
        return coin_flip_bet
    else:
        print("The result of the coin flip is " + result + ". Tough luck! You have lost " + str(coin_flip_bet) + "!")
        return -coin_flip_bet


cho_guess = input("Guess Even or Odd: ")
cho_guess = cho_guess.title()
cho_bet = input("How much you wanna bet? ")
cho_bet = int(cho_bet)


def cho_han(cho_guess, cho_bet):
    ...
    if result % 2 == 0 and cho_guess == "Even":
        ...
        print("The sum of the two dice is " + str(result) + " and is even. Tough luck! You have lost " + str(cho_bet) + ".")
        return -cho_bet
    elif result % 2 != 0 and cho_guess == "Even":
        print("The sum of the two dice is " + str(result) + " and is odd. Tough luck! You have lost " + str(cho_bet) + ".")
        return -cho_bet
    else:
        print("Not a valid guess")

pick_a_card_bet = input("How much you wanna bet before picking a card? ")
pick_a_card_bet = int(pick_a_card_bet)
...
money += heads_or_tails(coin_flip_call, coin_flip_bet)
print(""" """)
money += cho_han(cho_guess, cho_bet)
print(""" """)
money += pick_a_card(pick_a_card_bet)
print(""" """)
